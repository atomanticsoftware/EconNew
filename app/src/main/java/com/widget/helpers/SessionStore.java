...
public class SessionStore {
	...
	public static final String _SHARED_PREF = "_shared_pref";
	public static final String Data_UPDATE_PREF = "DataUpdatePref";
	...
	public static boolean storeUpdateInterval(Context context,
		...
		SharedPreferences sharedPrefrences = context.getSharedPreferences(
				Data_UPDATE_PREF, Context.MODE_PRIVATE);
	...
	public static void deleteUpdateInterval(Context context, int appWidgetId) {
		...
		Editor editor = context.getSharedPreferences(Data_UPDATE_PREF,
